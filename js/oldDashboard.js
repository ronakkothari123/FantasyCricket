...
function toggleTheme(){
    if(darkTheme){
        themeIcon.src = "./icons/darkinactive.svg"
        ...
        themeIcon.src = "./icons/darkactive.svg"
...
function createGameCard(matchLeague, matchDate, winnerTeam, loserTeam, winnerScore, winnerWickets, loserScore, loserWickets){
    ...
    headerImg.src = "./images/logos/" + matchLeague + ".png"
    ...
    winningTeamImg.src = "./images/teams/" + winnerTeam + ".png"
    ...
    loserTeamImg.src = "./images/teams/" + loserTeam + ".png"
