...
function toggleTheme(){
    if(darkTheme){
        themeIcon.src = "../FantasyCricket/icons/darkinactive.svg"
        ...
        themeIcon.src = "../FantasyCricket/icons/darkactive.svg"
...
function createGameCard(matchLeague, matchDate, winnerTeam, loserTeam, winnerScore, winnerWickets, loserScore, loserWickets){
    ...
    headerImg.src = "../FantasyCricket/images/logos/" + matchLeague + ".png"
    ...
    winningTeamImg.src = "../FantasyCricket/images/teams/" + winnerTeam + ".png"
    ...
    trophy.src = "../FantasyCricket/icons/trophy.svg"
    ...
    loserTeamImg.src = "../FantasyCricket/images/teams/" + loserTeam + ".png"
    ...
    lose.src = "../FantasyCricket/icons/lose.svg"
...
function createPlayerCard(firstName, lastName, team, bowlingStyle){
    ...
    teamImg.src = "../FantasyCricket/images/teams/" + team + ".png"
